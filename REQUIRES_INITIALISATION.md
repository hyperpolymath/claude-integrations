...
**This repository is not finished being set up.** 8 substitution token(s) across 9 file(s) still have no value.
...
- `firefox-mcp/CODE_OF_CONDUCT.md`
- `mozilla-extension/CODE_OF_CONDUCT.md`
...
- `firefox-mcp/ABI-FFI-README.md`
- `gecko-browser-extension/ABI-FFI-README.md`
- `gitlab-bridge/ABI-FFI-README.md`
- `mozilla-extension/ABI-FFI-README.md`
...
- `firefox-mcp/SECURITY.md`
- `mozilla-extension/SECURITY.md`
...
- `gecko-browser-extension/Justfile`
