...
= Contributing — claude-integrations
:revdate: 2026-MM-DD

== Audience

Developers working *on* `claude-integrations`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/claude-integrations.git
...
* Bugs in `claude-integrations`: file at `hyperpolymath/claude-integrations/issues`.
