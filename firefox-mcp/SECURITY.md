...
Replace all {{PLACEHOLDER}} values with your information:
  ...
  claude-integrations             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/claude-integrations/security/advisories/new)
...
- This repository (`hyperpolymath/claude-integrations`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/claude-integrations/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/claude-integrations/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/claude-integrations/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/claude-integrations/discussions) |
